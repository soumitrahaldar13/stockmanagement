...
<body>
	...
	<div id="root"></div>
	<!-- end -->
    <h2 style="text-align: center;padding-top: 20px;">Admin Page</h2>
     <h4 style="text-align: center;padding-top: 0px;">stock management system <p style="padding-top: 5px;"></p></h4>
    <div class="container">
    <form action="authentication/admin_login_action.php" name="myForm" method="post" class="w3_form_post" onsubmit="return validateForm()" enctype="multipart/form-data">
        ...
        <div class="form-container">
            ...
            <label class="form-row">
                <input autocomplete="one-time-code" type="test" id="email" name="email" placeholder="Mail-ID" required >
            </label>
            <label class="form-row">
         ...
         <?php
                    if (isset($_SESSION['error_msg'])) {
                        echo '<p class="error" style="color: red;">' . $_SESSION["error_msg"] . '</p>';
