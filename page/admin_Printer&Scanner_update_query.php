...
$query_m=$con->query("UPDATE `printerscanner` SET `GEM_NO`='$GEM_NO',`GEM_Date`='$GEM_Date',`VENDOR_NAME`='$VENDOR_NAME',`BRAND_NAME`='$BRAND_NAME',`Serial_Number`='$Serial_Number',`Model_No`='$Model_No',`Problem`='$Problem1',`START_DATE`='$START_DATE1',`END_DATE`='$END_DATE1',`Defunct`='$Defunct',`Item`='$Item' WHERE `id`='$id'");

if($query_m){
  //echo 1;die;
header("location:admin_Printer&Scanner.php");
}
