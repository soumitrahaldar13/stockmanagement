  ...
  <div class="home-content">
    ...
    <div class="sales-boxes">
      <div class="recent-sales box" style="width: 95%;">
        <div class="title">STOCK ALL AIO's </div>
        ...
        <div class="table-responsive box">
          ...
          <!-- <form method="post" action=""> -->
            <table cellpadding="0" cellspacing="0" border="0" class="table table-condensed" id="example">
              ...
              <tbody>
                <?php
                $query = mysqli_query($con, " SELECT * FROM `aio` WHERE `ewaste`='0' AND `active`= '0' ORDER BY `id` DESC") or die(mysqli_error($con));
                // echo 1;die;
                $counter = 0;
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><a href="admin_AIO_AMC.php?id=<?php echo $row['id']; ?>&AMC=<?php echo $row['is_amc']; ?>"><?php if ($row['is_amc'] == 0) { ?><span class="glyphicon glyphicon-unchecked" style="font-size:20px; color:red;">N</span> <?php } else { ?><span class="glyphicon glyphicon-unchecked" style="font-size:20px; color:GREEN;">Y</span><?php } ?></span></a></td>
                    ...
                    <td><?php if ($row['Defunct'] == 0 ) {  }else { ?><a href="admin_AIO_ewaste.php?id=<?php echo $row['id']; ?>"><span class="glyphicon glyphicon-send" style="font-size:20px; color:blue;"></span></a> <?php } ?> </td>
                    
                   <td disabled><?php if ($row['upgrade'] == 0) {}else{?><a href="Call_Log_upgrade.php?S_N=<?php echo $row['Serial_Number'];?>&id=<?php echo $row['id'];?>&PRODUCT=aio"><span class="glyphicon glyphicon-send" style="font-size:20px; color:blue;"></span></a> <?php }?></td>

                   
                  <?php
                  include 'admin_AIO_modify.php';
                }
