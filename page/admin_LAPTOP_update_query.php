...
$query=$con->query("UPDATE `laptop` SET `GEM_NO`='$GEM_NO',`GEM_Date`='$GEM_Date',`BRAND_NAME`='$BRAND_NAME',`Serial_Number`='$Serial_Number',`Model_No`='$Model_No',`Problem`='$Problem',`START_DATE`='$START_DATE1',`END_DATE`='$END_DATE1',`Defunct`='$Defunct',`SSD_Capacity`='$SSD_Capacity',`HDD_Capacity`='$HDD_Capacity',`Processor`='$Processor',`Processor_Base_Frequency`='$Processor_Base_Frequency',`ChipSet_Number`='$ChipSet_Number',`RAM`='$RAM',`Optical_Drive`='$Optical_Drive',`Graphic_Card`='$Graphic_Card',`Wireless`='$Wireless',`OS`='$OS',`OS_Serial_no`='$OS_Serial_no' ,`monitor_size`='$Monitor_Size' WHERE `id`='$id'");
