...
<!-- <div class="modal fade" id="update_modal<?php echo $row['id']?>" aria-hidden="true"> -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <form method="POST" action="admin_Printer&Scanner_update_query.php">
        <div class="modal-header">
          <h3 class="modal-title">Update Printer </h3>
        </div>
        <div class="modal-body">
          ...
          <div class="col-md-8">
            <div class="form-group">
             ...
             <input type="text" name="Item" value="<?php echo $row['Item']?>" class="form-control" required="required" readonly/>
            </div>
            <div class="form-group">
              <label > GEM NO: </label>
              <input type="hidden" name="id" value="<?php echo $row['id']?>"/>
