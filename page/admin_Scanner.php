...
// echo "INSERT INTO `scanner`(`id`, `GEM_NO`, `GEM_Date`, `VENDOR_NAME`, `BRAND_NAME`, `Serial_Number`, `Model_No`, `Delivery_Date`, `Problem`, `START_DATE`, `END_DATE`, `printing`, `printer`, `Item`, `Defunct`, `ewaste`, `AMC`) VALUES ('','$GEM_NO','$GEM_Date','$VENDOR_NAME','$BRAND_NAME','$Serial_Number','$Model_No','$Delevary_Date1','$Problem1','$START_DATE1','$END_DATE1','$printing','$printer','$item','0','0','0')";die;

  $query_Scanner = $con->query("INSERT INTO `scanner`(`id`, `GEM_NO`, `GEM_Date`, `VENDOR_NAME`, `BRAND_NAME`, `Serial_Number`, `Model_No`, `Delivery_Date`, `Problem`, `START_DATE`, `END_DATE`, `printing`, `printer`,`Defunct`, `ewaste`, `AMC`) VALUES ('','$GEM_NO','$GEM_Date','$VENDOR_NAME','$BRAND_NAME','$Serial_Number','$Model_No','$Delevary_Date1','$Problem1','$START_DATE1','$END_DATE1','$printing','$printer','0','0','0')");
 //echo 2;
  if ($query_Scanner) {
   // echo 3;
    echo "<script>alert('update Scanner Sucessfully');window.location.href='admin_Scanner.php'; </script>";
  } else {
  ...
  <div class="home-content">
        ...
        <form enctype="multipart/form-data" action="" id="wb_Form1" name="form" method="post">
          ...
          <div class="row">
	            ...
	            <div class="col-md-3">
	              ...
	              <div id="Serial_Number_check_S"></div>
	            </div>
	            <div class="col-md-3">
    ...
    <div class="sales-boxes">
      <div class="recent-sales box" style="width: 99%;">
        <div class="title">STOCK ALL Printer'S & Scanner'S</div>
        ...
        <div class="table-responsive box">
          ...
          <!-- <form method="post" action=""></form> -->
            <table cellpadding="0" cellspacing="0" border="0" class="table table-condensed" id="example">
              ...
              <tbody>
                <?php
                $query = mysqli_query($con, " SELECT * FROM `scanner` WHERE `ewaste`='0' ORDER BY `id` DESC") or die(mysqli_error($con));
                // echo 1;die;
                $counter = 0;
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><a href="admin_Scanner_AMC.php?id=<?php echo $row['id']; ?>&AMC=<?php echo $row['AMC']; ?>"><?php if ($row['AMC'] == 0) { ?><span class="glyphicon glyphicon-unchecked" style="font-size:20px; color:red;">N</span> <?php } else { ?><span class="glyphicon glyphicon-unchecked" style="font-size:20px; color:GREEN;">Y</span><?php } ?></span></a></td>
                    ...
                    <td <?php if ($row['Defunct'] == 0) { ?>hidden <?php } else {
                                                                  } ?>><a href="admin_Scanner_ewaste.php?id=<?php echo $row['id']; ?>"><span class="glyphicon glyphicon-send" style="font-size:20px; color:blue;"></span></a></td>
                  <?php
                  include 'admin_Scanner_modify.php';
                }
...
$(document).ready(function(){
    ...
    // alert(Serial_Number);
      $.ajax({
        type: 'POST',
        url: 'admin_Scanner_checky.php',
        data: {'Serial_Number':Serial_Number},
        success: function(data) {
           //alert(data);
          $('#Serial_Number_check_S').html(data);
        }
      })
    });
