    ...
    <div class="modal-content">
      <form method="POST" action="admin_CPU_update_query.php">
        <div class="modal-header">
          <h3 class="modal-title">Update CPU</h3>
        </div>
        <div class="modal-body">
          ...
          <div class="col-md-8">
             <div class="form-group">
              ...
              <input type="hidden" name="id" value="<?php echo $row['id'] ?>" />
                   <select id="item" name="item" class="form-control" required="required">
                    <option value="<?php echo $row['select_item'] ?>"><?php echo $row['select_item'] ?></option>
            ...
            <div class="form-group">
              ...
              <input type="hidden" name="id" value="<?php echo $row['id'] ?>" />
              <input type="text" name="Serial_Number" value="<?php echo $row['Serial_Number'] ?>" class="form-control" required="required" readonly/>
            </div>
            <div class="form-group">
        ...
        <div class="modal-footer">
          <button name="update_CPU" id="update_CPU" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span> Update</button>
