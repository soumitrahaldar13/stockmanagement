                  ...
                  <div class="table-responsive box">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-condensed" id="example">
                            ...
                            <tbody>
                                         ...
                                         <td <?php if($row['Defunct']==0){?>hidden <?php } else{ }?>><a href="admin_UPS_ewaste.php?id=<?php echo $row['id'];?>" ><span class="glyphicon glyphicon-send" style="font-size:20px; color:blue;"></span></a></td>
                                          <?php 
