      ...
      <form action="admin_PROFILE_ID_creation.php" 
        ...
        <div class="row">
          ...
          <div class="col-md-3 mb-3">
            ...
            <select name="role" id="role" class="form-control" onchange="toggleDiv()" required>
          ...
          <div class="col-md-3 mb-3 myDiv " id= "myDiv" style="display: none;">
          	<label for="role" class="form-label">Cell:</label>
...
function toggleDiv() {
        ...
        if (selectedValue === "USER") {
            divElement.style.display = "block"; // Or "flex", "inline-block", etc., based on desired layout
        } else {
