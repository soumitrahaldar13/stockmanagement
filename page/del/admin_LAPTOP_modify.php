<div class="modal fade" id="update_modal<?php echo $row['id'] ?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form method="POST" action="admin_LAPTOP_update_query.php">
        <div class="modal-header">
          <h3 class="modal-title">Update LAPTOP</h3>
        </div>
        ...
        <div class="modal-footer">
          <button name="update_LAPTOP" id="update_LAPTOP" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span> Update</button>
