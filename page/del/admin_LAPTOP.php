              ...
              <tbody>
                ...
                ?>
                  ...
                  <tr>
                   ...
                   <td disabled><?php if ($row['upgrade'] == 0) {}else{?><a href="Call_Log_upgrade.php?S_N=<?php echo $row['Serial_Number'];?>&id=<?php echo $row['id'];?>"><span class="glyphicon glyphicon-send" style="font-size:20px; color:blue;"></span></a> <?php }?></td>
